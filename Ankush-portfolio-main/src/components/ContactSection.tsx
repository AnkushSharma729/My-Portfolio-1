...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'bharadwajmr085@gmail.com',
    href: 'mailto:bharadwajmr085@gmail.com',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'ankush-sharma-1b83182a3',
    href: 'www.linkedin.com/in/ankush-sharma-1b83182a3',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@AnkushSharma729',
    href: 'https://github.com/AnkushSharma729',
  },
  {
    icon: Instagram,
    label: 'Instagram',
    value: '@akkiipandat_001',
    href: 'https://instagram.com/akkiipandat_001',
  },
];
      ...
      <FadeIn delay={0.4} y={20}>
        <div className="mx-auto mt-20 sm:mt-24 md:mt-28 flex max-w-5xl flex-col items-center gap-3 border-t border-[#D7E2EA]/10 pt-8 text-center sm:flex-row sm:justify-between">
          ...
          <span
            ...
            style={{ fontSize: 'clamp(0.7rem, 1.1vw, 0.9rem)' }}
          >
            Designed & built in Greate Noida,UP
          </span>
        </div>
      </FadeIn>
    </section>
