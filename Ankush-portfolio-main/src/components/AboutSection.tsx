...
const ABOUT_TEXT =
  "I am a passionate Frontend Developer pursuing a Diploma in Computer Science Engineering from Noida International University. I enjoy building responsive and user-friendly web applications using HTML, CSS, JavaScript, and modern web technologies. I continuously explore new technologies and work on projects to improve my skills and create better digital experiences.";
            ...
            <div className="flex flex-col gap-5 sm:gap-6">
              {[
                ...
                },
                {
                  ...
                  items: ['Basic React', 'Tailwind CSS', 'bootstrap'],
                },
                {
                  label: 'Tools & Platforms',
                  items: ['Git', 'GitHub', 'VS Code', 'Antigravity', 'Claude Code'],
                },
                {
                  label: 'Design Concepts',
                  items: ['UI/UX Basics', 'Figma', 'Canva'],
                },
              ].map((group) => (
                <div
                  key={group.label}
